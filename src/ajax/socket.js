 ...
 */
export const p2pApply = (otherId, ownId) =>
  socketEmit("apply", { account: otherId, self: ownId });
 ...
 * @param {string | number} ownId 自己的id
 */
export const sendPrivateMsg = (inputMsg, otherId, ownId, type = 1) =>
  socketEmitAndGetResponse("sendPrivateMsg", {
    message: inputMsg,
    to_user: otherId,
    from_user: ownId,
    type: type
